...
// Version timestamp: 2-10-2020, 8:26 AM
//
...
{
	double vapor_pressure_deficit = vapor_pressure.vapor_pressure_deficit;
	print_table(vapor_pressure.degrees_celcius, vapor_pressure.humidity*100, (float) (vapor_pressure.degrees_celcius_leaf - vapor_pressure.degrees_celcius), min_vpd, max_vpd);
	return (print_status(vapor_pressure_deficit, min_vpd, max_vpd));
}
...
{
	double vapor_pressure_deficit = calc_boundary(temperature, leaf_temperature, humidity);
	print_table(temperature, humidity, (float)(leaf_temperature - temperature), min_vpd, max_vpd);
	float result = print_status(vapor_pressure_deficit, min_vpd, max_vpd);
	return (result);
}
